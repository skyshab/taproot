...
function () {
  function AlphaColor(control) {
    ...
    if (!control) return false; // Set up our attributes
  ...
  _createClass(TaprootRange, [{
    ...
    value: function handlers() {
      ...
      self.$range.on('mousedown', function () {
        var stepPlaces = self.decimalPlaces($(this).attr('step')); // not sure if this is necessary. 
...
module.exports = __webpack_require__(/*! /Users/sky/Repos/taproot/resources/js/customize-controls.js */"./resources/js/customize-controls.js");
