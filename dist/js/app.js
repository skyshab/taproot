...
/* harmony import */ var _velocity_min_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./velocity.min.js */ "./resources/js/velocity.min.js");
/* harmony import */ var _velocity_min_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_velocity_min_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _app_header_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app/header.js */ "./resources/js/app/header.js");
...
/* harmony import */ var _app_nav_header_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app/nav-header.js */ "./resources/js/app/nav-header.js");
/* harmony import */ var _app_nav_header_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_app_nav_header_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _app_nav_navbar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app/nav-navbar.js */ "./resources/js/app/nav-navbar.js");
/* harmony import */ var _app_nav_navbar_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_app_nav_navbar_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _app_nav_toggle_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./app/nav-toggle.js */ "./resources/js/app/nav-toggle.js");
/* harmony import */ var _app_nav_toggle_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_app_nav_toggle_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _app_nav_dropdowns_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./app/nav-dropdowns.js */ "./resources/js/app/nav-dropdowns.js");
/* harmony import */ var _app_nav_dropdowns_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_app_nav_dropdowns_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _app_footer_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app/footer.js */ "./resources/js/app/footer.js");
/* harmony import */ var _app_footer_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_app_footer_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _app_general_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./app/general.js */ "./resources/js/app/general.js");
/* harmony import */ var _app_general_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_app_general_js__WEBPACK_IMPORTED_MODULE_7__);
/**
...
(function ($) {
   ...
   */
  var $body, $wrapper, $header, $footer, windowHeight, hasFixedFooter;
  /**
   * Fixed Footer
   */
...
(function ($) {
   ...
   * Variables available to our methods
   */
  var $body, $wrapper, $header, windowHeight, hasFixedHeader, fixedHeaderType;
  /**
  ...
  var headerCheck = function headerCheck(e) {
    ...
    var scrolled = $(window).scrollTop(); // store delta for determining scroll direction

    var delta = e.wheelDelta ? e.wheelDelta : -1 * e.deltaY; // if scrolled past window height and are scrolling down,
    // fix the header
  ...
  var fixTheHeader = function fixTheHeader() {
    if ($body.outerWidth() < 1025) {
      return false;
    }
    ...
    if (fixedHeaderType === 'sticky') {
      ...
      $header.css({
        top: '-150px'
      }).addClass("app-header--fixed").removeClass("app-header--static").velocity({
        top: $body.offset().top
      }, {
        duration: 700
      });
      ...
      if (!$header.hasClass('header--hero--fullscreen')) $wrapper.css('padding-top', $header.outerHeight());
      $header.css('opacity', '0').addClass("app-header--fixed").removeClass("app-header--static").velocity("fadeIn", {
        duration: 600
      });
    }
  };

  var unFixTheHeader = function unFixTheHeader() {
    if (fixedHeaderType != 'sticky') {
  ...
  var stickyHeaderInit = function stickyHeaderInit() {
  ...
  var setFixedHeaderType = function setFixedHeaderType() {
...
/***/ "./resources/js/app/nav-dropdowns.js":
/*!*******************************************!*\
  !*** ./resources/js/app/nav-dropdowns.js ***!
  \*******************************************/
/*! no static exports found */
...
(function ($) {
  ...
  var handlers = function handlers() {
    ...
    $targets.on('click', function (e) {
      ...
      e.preventDefault(); // if( $body.outerWidth() >= bp ) return false;
      ...
      if (parentItem.hasClass('submenu-open')) {
        ...
        parentItem.find('.menu__sub-menu').first().velocity("slideDown", {
          duration: 500
        });
        $(this).velocity({
          rotateZ: "180deg"
...
/***/ "./resources/js/app/nav-header.js":
/*!****************************************!*\
  !*** ./resources/js/app/nav-header.js ***!
  \****************************************/
/*! no static exports found */
...
(function ($) {
  ...
  var toggles = function toggles() {
    ...
    $header.on('click', '.menu--header .menu--toggle', function () {
      var headerNav = $('.menu--header'),
          headerMenu = headerNav.find('.menu__items'); // dropdown slide

      if (headerNav.hasClass('mobile-type-dropdown-slide')) {
        if ($(this).hasClass('open')) {
          headerMenu.velocity("slideDown", {
            duration: 500
          });
        } else {
  ...
  $(window).on("resize", function () {
    if ($wrapper.hasClass('header-slide-nav')) {// $('#header-menu-toggle').trigger('change');
    }
  });
})(jQuery);
...
/***/ "./resources/js/app/nav-navbar.js":
/*!****************************************!*\
  !*** ./resources/js/app/nav-navbar.js ***!
  \****************************************/
/*! no static exports found */
...
(function ($) {
  ...
  var toggles = function toggles() {
    ...
    $header.on('click', '.menu--navbar .menu--toggle', function () {
      var navbarNav = $('.menu--navbar'),
          navbarMenu = navbarNav.find('.menu__items'); // dropdown slide

      if (navbarNav.hasClass('mobile-type-dropdown-slide')) {
        if ($(this).hasClass('open')) {
          navbarMenu.velocity("slideDown", {
            duration: 500
          });
        } else {
  ...
  $(window).on("resize", function () {
    if ($wrapper.hasClass('navbar-slide-nav')) {// $('#navbar-menu-toggle').trigger('change');
    }
  });
})(jQuery);
...
/***/ "./resources/js/app/nav-toggle.js":
/*!****************************************!*\
  !*** ./resources/js/app/nav-toggle.js ***!
  \****************************************/
/*! no static exports found */
