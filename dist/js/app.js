...
function () {
  ...
  function TaprootHeader() {
    ...
    this.fixedOffset = 600; // set fixed header type
  ...
  _createClass(TaprootHeader, [{
    ...
    value: function headerCheck() {
      ...
      var scrolled = window.pageYOffset | document.body.scrollTop; // if screen is not wide enough, unfix and bail
    ...
    value: function slideInDown() {
      ...
      var slide = function slide(currentTime) {
        ...
        if (timeElapsed < duration) {
          ...
          self.header.style.transform = ''; // Doublecheck to make sure nothing changed while the animation was running
    ...
    value: function fadeIn() {
      ...
      var fade = function fade(currentTime) {
        ...
        if (timeElapsed <= duration) {
          ...
          self.header.classList.remove('is-animating'); // Doublecheck to make sure nothing changed while the animation was running
          // This prevents the header getting stuck as 'fixed' if scrolling back up to
          // the top of the screen during the animation.
...
/***/ 0:
/*!*****************************************************************************************************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/scss/theme.scss ./resources/scss/customize-controls.scss ./resources/scss/customize-preview.scss ./resources/scss/editor.scss ***!
  \*****************************************************************************************************************************************************************************/
/*! no static exports found */
...
__webpack_require__(/*! /Users/sky/Repos/skyshab/taproot/resources/scss/customize-preview.scss */"./resources/scss/customize-preview.scss");
module.exports = __webpack_require__(/*! /Users/sky/Repos/skyshab/taproot/resources/scss/editor.scss */"./resources/scss/editor.scss");
