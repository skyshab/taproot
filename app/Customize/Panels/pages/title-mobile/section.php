...
$manager->add_section( 'pages--title-mobile', [
...
range( $manager, 'pages--title-mobile--font-size', [
    'section' => 'pages--title-mobile',
...
range( $manager, 'pages--title-mobile--line-height', [
    'section' => 'pages--title-mobile',
