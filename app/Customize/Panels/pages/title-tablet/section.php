...
$manager->add_section( 'pages--title-tablet', [
...
range( $manager, 'pages--title-tablet--font-size', [
    'section' => 'pages--title-tablet',
...
range( $manager, 'pages--title-tablet--line-height', [
    'section' => 'pages--title-tablet',
