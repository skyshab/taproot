...
// blog title size
$defaults->add( 'pages--title-tablet--font-size', '2.5em' );

// Disable Font Size by default
$defaults->add( 'pages--title-tablet--font-size--enable', false );


// pages title line-height
$defaults->add( 'pages--title-tablet--line-height', '1.05' );

// Disable Line Height by default
$defaults->add( 'pages--title-tablet--line-height--enable', false );
