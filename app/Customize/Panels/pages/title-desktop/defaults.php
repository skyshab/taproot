...
// blog title size
$defaults->add( 'pages--title-desktop--font-size', '3em' );

// Disable Font Size by default
$defaults->add( 'pages--title-desktop--font-size--enable', false );


// pages title line-height
$defaults->add( 'pages--title-desktop--line-height', '1.05' );

// Disable Line Height by default
$defaults->add( 'pages--title-desktop--line-height--enable', false );
