...
// Tagline font size
$defaults->add( 'branding--tagline-desktop--font-size', '1em' );


// Tagline line height
$defaults->add( 'branding--tagline-desktop--line-height', '1' );


// Tagline gutter
$defaults->add( 'branding--tagline-desktop--gutter', '0.1em' );