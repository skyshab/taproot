...
$styles->add_var([
    ...
    'value' => theme_mod( 'typography--sidebar-tablet--font-size' ),
    'screen' => 'desktop',
]);
...
$styles->add_var([
    ...
    'value' => theme_mod( 'typography--sidebar-tablet--line-height' ),
    'screen' => 'desktop',
]);
...
$styles->add_var([
    ...
    'value' =>  maybe_convert_to_em( theme_mod( 'typography--sidebar-tablet--line-height' ) ),
