...
// Enable Breadcrumbs
$defaults->add( 'elements--breadcrumbs--enable', 1 );


// Breadcrumbs align
$defaults->add( 'elements--breadcrumbs--align', 'flex-start' );


// Enable Breadcrumbs Home icon
$defaults->add( 'elements--breadcrumbs--home-icon', 1 );
