...
// blog title size
$defaults->add( 'blog--title-desktop--font-size', '3em' );

// Disable Font Size by default
$defaults->add( 'blog--title-desktop--font-size--enable', false );


// blog title line-height
$defaults->add( 'blog--title-desktop--line-height', '1.05em' );

// Disable Line Height by default
$defaults->add( 'blog--title-desktop--line-height--enable', false );
