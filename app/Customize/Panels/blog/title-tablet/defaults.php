...
// blog title size
$defaults->add( 'blog--title-tablet--font-size', '2.5em');

// Disable Font Size by default
$defaults->add( 'blog--title-tablet--font-size--enable', false );


// blog title line-height
$defaults->add( 'blog--title-tablet--line-height', '1.05em' );

// Disable Line Height by default
$defaults->add( 'blog--title-tablet--line-height--enable', false );
