...
$styles->var([
    ...
    'value' => get_theme_mod( 'typography--sidebar-desktop--font-size' ),
    'screen' => 'desktop',
]);
...
$styles->var([
    ...
    'value' => get_theme_mod( 'typography--sidebar-desktop--line-height' ),
    'screen' => 'desktop',
]);
...
$styles->var([
    ...
    'value' =>  maybe_convert_to_em( get_theme_mod( 'typography--sidebar-desktop--line-height' ) ),
    'screen' => 'desktop',
]);