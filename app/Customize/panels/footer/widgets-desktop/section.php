...
$manager->add_section( 'footer--widgets-desktop', [
    'title' => esc_html__( 'Widgets - Desktop', 'taproot' ),
    'panel' => 'footer',
]);
...
$manager->add_setting( 'footer--widgets-desktop--layout', [
    'sanitize_callback' => 'sanitize_text_field',
    'transport' => 'postMessage',
]);

$manager->add_control( 'footer--widgets-desktop--layout', [
    'type' => 'select',
