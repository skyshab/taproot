...
$styles->add_var([
    ...
    'value' => theme_mod('typography--h5-mobile--font-size'),
...
$styles->add_var([
    'name' => 'typography--h5--font-size',
    'value' => theme_mod('typography--h5-tablet--font-size'),
...
$styles->add_var([
    'name' => 'typography--h5--font-size',
    'value' => theme_mod('typography--h5-desktop--font-size'),
    'screen' => 'editor-desktop',
    'selector' => '.edit-post-layout:not(.is-sidebar-opened)'
]);
...
$styles->add_var([
    ...
    'value' => theme_mod('typography--h5-mobile--line-height'),
    'selector' => '.editor-styles-wrapper .wp-block',
]);
...
$styles->add_var([
    'name' => 'typography--h5--line-height',
    'value' => theme_mod('typography--h5-tablet--line-height'),
    'screen' => 'editor-tablet',
    'selector' => '.edit-post-layout:not(.is-sidebar-opened)'
]);
...
$styles->add_var([
    'name' => 'typography--h5--line-height',
    'value' => theme_mod('typography--h5-desktop--line-height'),
    'screen' => 'editor-desktop',
    'selector' => '.edit-post-layout:not(.is-sidebar-opened)'
]);
