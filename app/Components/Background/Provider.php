...
use Taproot\Components\Background\Customize\Customize;
...
class Provider extends ServiceProvider {
    ...
    public function boot() {
        ...
        // Add component customize panel to collection.
        $this->app->resolve( 'customize/components' )->add( 'background', $this->app->resolve( Customize::class ) );
    }
}
