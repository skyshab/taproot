...
use Taproot\Components\Fonts\Customize\Customize;
use Taproot\Components\Fonts\Functions;
...
class Provider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton( 'fonts', Functions::class );
    }
    ...
    public function boot() {
        ...
        $this->app->resolve( 'customize/components' )->add( 'fonts',  $this->app->resolve( Customize::class ) );
    }
}
