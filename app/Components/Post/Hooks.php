...
use Taproot\Components\Post\Breadcrumbs\Crumb_Home;
...
class Hooks implements Bootable {
    ...
    public function entry_content_template( $data ) {
        ...
        $data['entry_content_template'] = ( app('post/functions')->use_excerpt() ) ? 'entry/summary' : 'entry/content';
    ...
    public function excerpt_more( $more ) {
        return app('post/template')->get_the_excerpt_more_link();
    }
    ...
    public function excerpt_length( $length ) {
        ...
        $custom_length = app('post/functions')->get_entry_excerpt_length();
