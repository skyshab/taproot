...
use Taproot\Components\Navigation_Navbar\Customize\Customize;
...
class Component extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton( 'nav/navbar/functions', Functions::class );
    }
    ...
    public function boot() {
        ...
        $this->app->resolve( 'customize/components' )->add( 'navigation/navbar', $this->app->resolve( Customize::class ) );
    }
}
