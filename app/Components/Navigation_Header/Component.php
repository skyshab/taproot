...
use Taproot\Components\Navigation_Header\Customize\Customize;
...
class Component extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton( 'nav/header/functions', Functions::class );
    }
    ...
    public function boot() {
        ...
        $this->app->resolve( 'customize/components' )->add( 'navigation/header', $this->app->resolve( Customize::class ) );
    }
}
