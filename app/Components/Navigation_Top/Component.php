...
use Taproot\Components\Navigation_Top\Customize\Customize;
...
class Component extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton( 'nav/top/functions', Functions::class );
    }
    ...
    public function boot() {
        ...
        $this->app->resolve( 'customize/components' )->add( 'navigation/top', $this->app->resolve( Customize::class ) );
    }
}
