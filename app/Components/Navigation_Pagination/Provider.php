...
use Taproot\Components\Navigation_Pagination\Customize\Customize;
...
class Provider extends ServiceProvider {
    ...
    public function boot() {
        ...
        $this->app->resolve( 'customize/components' )->add( 'navigation/pagination', $this->app->resolve( Customize::class ) );
    }
}
