...
namespace Taproot\Components\Entry;

use Hybrid\Tools\ServiceProvider;
use Taproot\Tools\Mod;
use Taproot\Components\Entry\Customize\Customize                       as Component;
use Taproot\Components\Entry\Customize\Post_Type\Customize             as ComponentPostType;
use Taproot\Components\Entry\Customize\Single\Customize                as ComponentSingle;
use Taproot\Components\Entry\Customize\Single\Customize_Hierarchical   as ComponentSingleHierarchical;
use Taproot\Components\Entry\Customize\Archive\Customize               as ComponentArchive;
use Taproot\Components\Entry\Customize\Archive_Entry\Customize         as ComponentArchiveEntry;
...
class Provider extends ServiceProvider {
    ...
    public function register() {
        ...
        $this->app->singleton( 'entry/template', Template::class );
    }
    ...
    public function boot() {
        ...
        $components->add( 'entry', $this->app->resolve( Component::class ) );

        // Once post types have been registered
        add_action( 'init', function() use ( $components ) {

            // Supported post types array
            $supported = apply_filters('components/entry/customizer-support', explode( ',', Mod::get( 'enabled-post-types', 'post,page' ) ) );
