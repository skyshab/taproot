 ...
 * @since 0.8.0
 */
if( !class_exists('WP_Rootstrap_Customizer_Tabs') )
{
    class WP_Rootstrap_Customizer_Tabs
    {
        /**
         ...
         */
         public function __construct( $wp_customize, $root_id, $group_args )
         {
             // get our custom tabs control
             require_once dirname( __FILE__ ) . '/class-wp-rootstrap-customizer-tabs-control.php';
